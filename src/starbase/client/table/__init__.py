...
class Table(object):
    ...
    def fetch_all_rows(self, with_row_id=False, raw=False, perfect_dict=None, flat=False, filter_string=None, scanner_config=''):
        ...
        res = self._scanner( filter_string=filter_string, data=scanner_config ).results(perfect_dict=perfect_dict, with_row_id=with_row_id, raw=raw)
        if flat:
            res = list(res)
    ...
    def _scanner(self, batch_size=None, start_row=None, end_row=None, start_time=None, end_time=None, filter_string=None, data=''):
        """
